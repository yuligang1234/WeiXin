...
namespace WeiXin.Tools.Win
{
    ...
    {
        private delegate void Setprogress1();
        ...
        private void HideProgress()
        {
            ...
            {
                while (!progressPanel1.IsHandleCreated)
                {
                    if (progressPanel1.Disposing || progressPanel1.IsDisposed)
                    {
                        return;
                    }
                }
                Setprogress1 s = HideProgress;
                progressPanel1.Invoke(s);
            }
            else
            {
