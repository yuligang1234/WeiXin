...
namespace WeiXin.DAL
{
    public class SendMsg
    {
        ...
        public static void ReplayTemplete(Dictionary<string, string> model)
        {
            ...
            json.Append("\",\"template_id\":\"JUif5V5O1PEhmdl8IDsNNlS6xVp_yHNSq0PIh8F9iTk\",\"url\":\"\",\"topcolor\":\"#FF0000\",\"data\":{\"first\": {\"value\":\"您好，您有一条工单提醒\",\"color\":\"#173177\"},\"keyword1\":{\"value\":\"OA20140830123456\",\"color\":\"#173177\"},\"keyword2\":{\"value\":\"关于某文件的审批审阅\",\"color\":\"#173177\"},\"keyword3\":{\"value\":\"待审核\",\"color\":\"#173177\"},\"remark\":{\"value\":\"请登录OA系统及时处理。\",\"color\":\"#173177\"}}}");
