...
namespace WeiXin.DAL
{
    public class SendMsg
    {
        ...
        /// <param name="title">title</param>
        /// <param name="description">描述</param>
        /// <param name="musicUrl">描述</param>
        /// <param name="hqMusicUrl">描述</param>
        /// <param name="thumbMediaId">描述</param>
        /// Author  : 俞立钢
        /// Company : 绍兴标点电子技术有限公司
        /// Created : 2014-10-24 10:25:01
        private static void ProduceMusic(Dictionary<string, string> model, int mediaId, string title, string description, string musicUrl, string hqMusicUrl, int thumbMediaId)
        {
            SendVideo video = new SendVideo();
            video.ToUserName = model.ReadKey(PublicField.FromUserName);
            video.FromUserName = model.ReadKey(PublicField.ToUserName);
